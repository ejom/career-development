...
- Create conversations to induce LLM model failure across a variety of metrics.

- Document LLM failure analysis across various metrics such as safety, accuracy, and interaction quality.

- Create software engineering environments to test LLM model capabilities using Docker and CLI tools (Linux/WSL shell scripting).
...
- Create ideal solutions to graduate level STEM domain prompts.
...
- Built an AI job board powered by agentic workflows, ML embedded vector models, and browser agents.
...
- Utilized TypeScript Next.js/Vite, Python FastAPI, PostgreSQL, Docker, Linux Ubuntu CLI, and Git.
